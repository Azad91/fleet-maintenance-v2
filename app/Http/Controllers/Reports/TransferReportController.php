...
class TransferReportController extends ReportController
{
    ...
    public function workerActivity(Request $request): View|BinaryFileResponse
    {
        ...
        if ($export = $this->maybeExport(
            request: $request,
            basename: 'transfer-worker-activity',
            headings: [
