...
return [
    ...
    'complaints' => [
        ...
        'service_hint' => 'Services are shown based on the current bus mileage.',
        'motor_oil_service_label' => 'Motor Oil Change — :km km',
        'no_intervals' => 'No suitable service found for this bus.',
        'no_parts_for_interval' => 'No parts found for this service.',
        'complaint' => 'Complaint',
        'complaints_list' => 'Complaints',
        'select_complaint' => 'Select complaint...',
        'import_historical_label' => 'Historical import — do not touch stock',
        'import_historical_hint' => 'Check this when importing past complaints. The parts used on each complaint will be saved for reference, but warehouse and service vehicle stock will NOT be modified. Deleting or editing these complaints later also leaves stock untouched.',
        'import_success_historical' => ':count historical cards imported successfully. Stock was not modified.',
    ...
    'warehouse' => [
        ...
        'import_mode_hint' => 'Choose how existing items\' quantities should be treated when the same code appears again.',
        'import_mode_overwrite' => 'Overwrite',
        'import_mode_overwrite_hint' => 'The Excel quantity REPLACES the stored quantity. Use when the file is a full inventory snapshot.',
        'import_mode_add' => 'Add to stock',
        'import_mode_add_hint' => 'The Excel quantity is ADDED to the stored quantity. Use when receiving new parts (e.g. 500 L in stock + 2000 L arriving → 2500 L).',
        'import_mode_badge' => 'Mode',
        'unit' => 'Unit',
        'price' => 'Unit Price',
        ...
        'quarantine_short' => 'Q',
        'quarantine_hint' => 'Items moved here are no longer part of active stock. They are kept for inspection, reporting or disposal.',
        'units' => [
            'piece' => 'Piece',
            'liter' => 'Liter',
            'meter' => 'Meter',
    ...
    'service_vehicles' => [
        ...
        'stocks_subtitle' => 'Select a vehicle to see its current stock.',
        'stocks_item_count' => 'Items',
        'stocks_total_qty' => 'Total Qty',
    ...
    'super_admin' => [
        ...
        'companies' => [
            ...
            'no_director_warning' => 'This company has no active director! Please assign one.',
            ...
            'created_with_director' => 'Company ":name" and its Director ":director" created successfully.',
            ...
            'director_name_placeholder' => 'e.g.: Rashad Aliyev',
            'director_email' => 'Director Email',
            'director_password' => 'Password',
            'director_password_confirm' => 'Confirm Password',
            'director_password_hint' => 'Minimum 8 characters.',
            'director_pin' => 'PIN',
            'director_pin_confirm' => 'Confirm PIN',
            'director_pin_hint' => '4-6 digits. Will be required to change on first login.',

            'director_name_required' => 'Director name is required.',
            'director_email_required' => 'Director email is required.',
            'director_email_taken' => 'This email is already in use.',
            'director_password_required' => 'Director password is required.',
            'director_pin_required' => 'Director PIN is required.',
            'director_pin_digits' => 'PIN must be 4-6 digits.',
            'director_pin_mismatch' => 'PIN confirmation does not match.',
        ],
        ...
        'garages' => [
            ...
            'users_count' => 'Users',
            'admins_count' => 'Admins',
            'no_admin_warning' => 'This garage has no active admin! Please assign one.',
            ...
            'created_with_admin' => 'Garage ":name" and its Admin ":admin" created successfully.',
            ...
            'admin_name_placeholder' => 'e.g.: Elshad Mammadov',
            ...
            'admin_pin_hint' => '4-6 digits. Will be required to change on first login.',

            'admin_name_required' => 'Admin name is required.',
            'admin_email_required' => 'Admin email is required.',
            'admin_email_taken' => 'This email is already in use.',
            'admin_password_required' => 'Admin password is required.',
            'admin_pin_required' => 'Admin PIN is required.',
            'admin_pin_digits' => 'PIN must be 4-6 digits.',
            'admin_pin_mismatch' => 'PIN confirmation does not match.',
        ],
        ...
        'users' => [
            ...
            'create_scope_warning' => 'This screen is for creating individual users only. To create a Company Director, use Companies → New Company. To create a Garage Admin, use Garages → New Garage.',
            'name' => 'Full Name',
        ...
        'assignments' => [
            ...
            'change_director' => 'Change Director',
            'change_director_warning' => 'Warning: the current director :current will be deactivated and lose access to this company.',
            'change_director_button' => 'Change Director',
            ...
            'director_changed' => 'Director changed. :old was deactivated, :new is now the active director of :company.',
    ...
    'reports' => [
        ...
        'content' => [
            ...
            'no_activity' => 'No maintenance activity in this period.',
            'no_motor_oil' => 'No motor oil changes in this period.',
            'ranking_by_cards' => 'Ranked by number of cards',
            'period_label' => 'Period',
            ...
            'no_dead_stock'           => 'No dead stock — every item has been consumed at least once.',
            'dead_stock_hint'         => 'These items have never been consumed in any complaint. They represent capital tied up in inventory.',
            'items'                   => 'Items',
            'critical'                => 'Critical',
            'upcoming_hint'           => 'Buses whose next oil change is due within the next 30 days. Days are estimated using the fleet\'s average daily distance.',
            'monthly'                 => 'Monthly',
            'quarterly'               => 'Quarterly',
            'per_bus'                 => 'Per bus',
            'per_complaint'           => 'Per complaint',
            'per_complaint_hint'      => 'Average number of parts consumed per complaint in the selected period.',
        ],
        'oil_change' => [
            'title'          => 'Oil Change Reports',
            'history'        => 'History',
            'upcoming'       => 'Upcoming (30 days)',
            'counts'         => 'Monthly / Quarterly Count',
            'adherence'      => 'Schedule Adherence',
            'catalog_usage'  => 'Catalog Usage',
        ],
        'parts_usage' => [
            'title'          => 'Parts Usage',
            'per_bus'        => 'Per Bus',
            'top_consumed'   => 'Top Consumed',
            'bus_cost'       => 'Bus Cost',
            'per_complaint'  => 'Per Complaint',
    ...
    'flash' => [
        ...
        'service_vehicle_required' => 'A service vehicle must be selected for road complaints.',
        'service_vehicle_not_found' => 'The selected service vehicle was not found.',
        'service_vehicle_part_not_found' => "Part ':code' was not found on ':vehicle'. Please restock the vehicle from the warehouse first.",
        'service_vehicle_stock_insufficient' => "Not enough ':name' on ':vehicle' (required: :requested, available: :available). Please restock the vehicle from the warehouse first.",
    ...
    'two_factor' => [
        ...
        'code_hint' => 'Copy the code from Google Authenticator or a similar app. A recovery code also works if needed.',
        'verify' => 'Verify',
        'cancel' => 'Cancel and Go Back',
        'invalid_code' => 'The code is invalid or has expired.',
        'already_enabled' => 'Two-factor authentication is already enabled.',
        'secret_missing' => 'The setup session expired. Please start again.',
        'setup_required' => 'Two-factor authentication is required for SuperAdmin accounts. Please complete the setup.',
        'setup_title' => 'Set Up Two-Factor Authentication',
        'step_1_title' => 'Step 1 — Scan the QR Code',
        'step_1_hint' => 'Open Google Authenticator, Authy, or a similar app and scan the QR code below.',
        'manual_entry' => 'If you cannot scan the QR code, enter this key manually:',
        'step_2_title' => 'Step 2 — Verify',
        'step_2_hint' => 'Enter the 6-digit code shown in the app and confirm.',
        'enable' => 'Enable Two-Factor Authentication',
        'recovery_title' => 'Recovery Codes',
        'recovery_warning' => 'Copy these codes now! They are the only way to access your account if you lose your phone. They will not be shown again.',
        'recovery_codes' => 'One-Time Recovery Codes',
        'saved_codes' => 'I Saved the Codes, Continue',
    ...
    'transfers' => [
        ...
        'direction' => 'Direction',
        'direction_all' => 'All',
        'direction_outbound' => 'Outbound (sent)',
        'direction_inbound' => 'Inbound (received)',
        'status' => 'Status',
        ...
        'receive_modal_title' => 'Receive Transfer',
        'reject_modal_title' => 'Reject Transfer',
        'reject_reason' => 'Reason (optional)',
        'resolve_modal_title' => 'Resolve Disputed Transfer',
        'resolve_retransfer' => 'Re-send missing quantities',
        'resolve_loss' => 'Write off as lost',
        ...
        'cannot_dispatch' => 'Only draft transfers can be dispatched.',
        'cannot_receive' => 'Only dispatched transfers can be received.',
        'cannot_reject' => 'Only dispatched transfers can be rejected.',
        'cannot_resolve' => 'Only disputed transfers can be resolved.',
        'cannot_cancel' => 'Only draft transfers can be cancelled.',
        ...
        'quarantine_hint' => 'These items are removed from active stock and moved to the quarantine bucket of the source garage.',
        'completed' => 'Transfer completed.',
        'type_requires_workflow' => 'This transfer type requires the full dispatch → receive workflow.',
        'dashboard_eyebrow' => 'REQUIRES ATTENTION',
        'dashboard_title' => 'Warehouse Transfers',
        'inbound_pending_label' => 'Incoming Transfers',
        'inbound_pending_hint' => 'Waiting for your acceptance',
        'outbound_pending_label' => 'Outgoing Transfers',
        'outbound_pending_hint' => 'Waiting for the other party',
