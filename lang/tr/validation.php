...
return [
    ...
    'array_keys' => ':attribute alanı yalnız şu anahtarları içermelidir: :values.',
    'ascii' => ':attribute alanı yalnız tek baytlı alfanumerik karakterler ve semboller içermelidir.',
    ...
    'can' => ':attribute alanı izinsiz bir değer içeriyor.',
    ...
    'in_array_keys' => ':attribute alanı en az şu anahtarlardan birini içermelidir: :values.',
    ...
    'attributes' => [
        ...
        'employee_id' => 'çalışan',
        'details' => 'detaylar',
        'details.*.code' => 'parça kodu',
        'details.*.used_quantity' => 'kullanılan miktar',
        'details.*.employee_id' => 'çalışan',
        'details.*.notes' => 'not',
